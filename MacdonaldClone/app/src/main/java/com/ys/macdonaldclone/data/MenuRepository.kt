        ...
        return Menu(
            ...
            menuItems = listOf(
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_big_mac.png",
                ...
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_quarter_pounder_with_cheese.png",
                    price = getRandomPrice(),
                    categoryId = 1
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_double_quarter_pounder_with_cheese.png",
                    price = getRandomPrice(),
                    categoryId = 1
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_quarter_pounder_with_cheese_deluxe.png",
                    price = getRandomPrice(),
                    categoryId = 1
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_mcdouble.png",
                    price = getRandomPrice(),
                    categoryId = 1
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_quarter_pounder_with_cheese_bacon.png",
                    price = getRandomPrice(),
                    categoryId = 1
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_cheeseburger.png",
                    price = getRandomPrice(),
                    categoryId = 1
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_double_cheeseburger.png",
                    price = getRandomPrice(),
                    categoryId = 1
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_hamburger.png",
                    price = getRandomPrice(),
                    categoryId = 1
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_mcchicken.png",
                    price = getRandomPrice(),
                    categoryId = 1
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_filet_o_fish.png",
                    price = getRandomPrice(),
                    categoryId = 1
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_small_french_fries.png",
                    price = getRandomPrice(),
                    categoryId = 2
                ),
                MenuItem(
                    ...
                    description = "Our World Famous Fries are made with premium potatoes such as the Russet Burbank and the Shepody. With 0g of trans fat per labeled serving, these epic fries are crispy and golden on the outside and fluffy on the inside.",
                    image = "${IMAGE_PATH}menu_item_medium_french_fries.png",
                    price = getRandomPrice(),
                    categoryId = 2
                ),
                MenuItem(
                    ...
                    description = "Our World Famous Fries are made with premium potatoes such as the Russet Burbank and the Shepody. With 0g of trans fat per labeled serving, these epic fries are crispy and golden on the outside and fluffy on the inside.",
                    image = "${IMAGE_PATH}menu_item_large_french_fries.png",
                    price = getRandomPrice(),
                    categoryId = 2
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_coca_cola.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_sprite.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_fanta_orange.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_diet_coke.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_chocolate_shake.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_vanilla_shake.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_strawberry_shake.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_mccafe_hot_chocolate.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_iced_tea.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_minute_maid_premium_orange_juice.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_minute_maid_fruit_punch_slushie.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_minute_maid_blue_raspberry_slushie.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_minute_maid_pink_lemonade_slushie.png",
                    price = getRandomPrice(),
                    categoryId = 3
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_big_mac_combo_meal.png",
                    price = getRandomPrice(),
                    categoryId = 4
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_cheeseburger_combo_meal.png",
                    price = getRandomPrice(),
                    categoryId = 4
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_quarter_pounder_with_cheese_meal.png",
                    price = getRandomPrice(),
                    categoryId = 4
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_double_quarter_pounder_with_cheese_meal.png",
                    price = getRandomPrice(),
                    categoryId = 4
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_ten_piece_chicken_mcnuggets_meal.png",
                    price = getRandomPrice(),
                    categoryId = 4
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_filet_o_fish_meal.png",
                    price = getRandomPrice(),
                    categoryId = 4
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_hamburger_happy_meal.png",
                    price = getRandomPrice(),
                    categoryId = 5
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_four_piece_chicken_mcnuggets_happy_meal.png",
                    price = getRandomPrice(),
                    categoryId = 5
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_six_piece_chicken_mcnuggets_happy_meal.png",
                    price = getRandomPrice(),
                    categoryId = 5
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_vanilla_cone.png",
                    price = getRandomPrice(),
                    categoryId = 6
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_hot_fudge_sundae.png",
                    price = getRandomPrice(),
                    categoryId = 6
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_mcflurry_with_m_and_m_candies.png",
                    price = getRandomPrice(),
                    categoryId = 6
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_kiddie_cone.png",
                    price = getRandomPrice(),
                    categoryId = 6
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_hot_caramel_sundae.png",
                    price = getRandomPrice(),
                    categoryId = 6
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_mcflurry_with_oreo_cookies.png",
                    price = getRandomPrice(),
                    categoryId = 6
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_baked_apple_pie.png",
                    price = getRandomPrice(),
                    categoryId = 6
                ),
                MenuItem(
                    ...
                    image = "${IMAGE_PATH}menu_item_chocolate_chip_cookie.png",
                    price = getRandomPrice(),
                    categoryId = 6
                ),
            ),
