...
import com.ys.macdonaldclone.data.CategoriesRepository
...
private fun CategoryTab(
    ...
    val transition = updateTransition(targetState = if (selected) CategoryTabState.Selected else CategoryTabState.NotSelected,
        label = ""
    )
